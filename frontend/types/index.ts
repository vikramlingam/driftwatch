...
export const TARGET_URL_MAP: Record<string, string> = {
  ...
  'LangGraph (Stateful)': 'https://raw.githubusercontent.com/langchain-ai/langgraph/main/CHANGELOG.md',
  'CrewAI & Multi-Agent': 'https://raw.githubusercontent.com/crewAIInc/crewAI/main/CHANGELOG.md',
  'LiteLLM (AI Gateway)': 'https://raw.githubusercontent.com/BerriAI/litellm/main/CHANGELOG.md',
  'DSPy (Prompt Optimizer)': 'https://raw.githubusercontent.com/stanfordnlp/dspy/main/CHANGELOG.md',
  'vLLM (Inference Engine)': 'https://raw.githubusercontent.com/vllm-project/vllm/main/CHANGELOG.md',
  'Hugging Face Transformers': 'https://raw.githubusercontent.com/huggingface/transformers/main/CHANGELOG.md',
  ...
  'Qdrant Vector Engine': 'https://raw.githubusercontent.com/qdrant/qdrant/master/CHANGELOG.md',
  'Weaviate Vector DB': 'https://raw.githubusercontent.com/weaviate/weaviate/master/CHANGELOG.md',
  ...
  'Drizzle ORM': 'https://raw.githubusercontent.com/drizzle-team/drizzle-orm/main/CHANGELOG.md',
  'Bun Runtime': 'https://raw.githubusercontent.com/oven-sh/bun/main/CHANGELOG.md',
